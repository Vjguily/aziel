...
const Leave = () => {
  ...
  const getPaperHeight = () => {
    ...
    if (isTablet) return "35vh";
    if (isLaptop) return "30vh";
    return "100vh";
  };
  ...
  return (
    ...
    >
      {/* <Paper sx={{ flexGrow: 1, height: getPaperHeight() }}> */}
      <div>
        <Box
          sx={{
        ...
        <Box sx={{ p: 2, mt: isMobile ? -42 : -30 }}>
          <Grid container spacing={2}>
            <Grid item xs={12} md={6}>
              ...
              <Box sx={{ p: 2, pt: 0 }}>
               ...
               <Card sx={{mt:isMobile ? -1.5 :isTablet ? 0 : 1}}>
                ...
                <Card component="form" sx={{ p: 2, backgroundColor: "#940b92", m : isMobile ? 1 :isTablet? 0: 4 }}>
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                <IconButton sx={iconStyle(isMobile)}>
                  <HomeIcon fontSize={isMobile ? "medium" : isTablet ? "large" : "large"} />
                </IconButton>
                <IconButton sx={iconStyle(isMobile)} style={{ borderRadius: "10px solid" }}>
                  <FitnessCenterIcon fontSize={isMobile ? "medium" : isTablet ? "large" : "large"} />
                </IconButton>
                <IconButton sx={iconStyle(isMobile)}>
                  <EditIcon fontSize={isMobile ? "medium" : isTablet ? "large" : "large"} />
                </IconButton>
                <Button
                  variant="contained"
                  sx={{
                  ...
                  startIcon={<ChatIcon fontSize={isMobile ? "medium" : isTablet ? "large" : "large"} />}
                >
                  Permission
                </Button>
                <IconButton sx={iconStyle(isMobile)}>
                  <SecurityIcon fontSize={isMobile ? "medium" : isTablet ? "large" : "large"} />
                </IconButton>
                <IconButton sx={iconStyle(isMobile)}>
                  <AccountCircleIcon fontSize={isMobile ? "medium" : isTablet ? "large" : "large"} />
                </IconButton>
              </div>
            </Grid>
          </Grid>
